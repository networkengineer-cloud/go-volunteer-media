 ...
 * 
 * Tests for the specific dark mode issues:
 * 1. Login page - username field shows with white background
 * 2. Password setup page - password field shows with white background
 */
...
test.describe('Dark Mode Field Fixes', () => {
  ...
  test('visual regression - login and setup password pages with dark mode enabled', async ({ page }) => {
