...
func main() {
	...
	fmt.Println("  Group Admin (password: demo1234):             mjaeger  (Merry Jaeger)")
	fmt.Println("  Group Admin (password: demo1234):             snijem   (Sophia Nijem)")
	fmt.Println("  Volunteer (password: volunteer2026!):         twallace (Terry Wallace)")
	fmt.Println("  Volunteer (password: volunteer2026!):         alex     (Alex Rivera)")
	fmt.Println("  Volunteer (password: volunteer2026!):         jordan   (Jordan Chen)")
	fmt.Println("  Volunteer (password: volunteer2026!):         casey    (Casey Morgan)")
	fmt.Println("  Volunteer (password: volunteer2026!):         taylor   (Taylor Brooks)")
	fmt.Println("\nAll users have access to the ModSquad group.")
	fmt.Println("mjaeger and snijem are group admins for ModSquad.")
